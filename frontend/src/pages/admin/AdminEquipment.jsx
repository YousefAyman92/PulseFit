...
const s = {
  ...
  badgeAvailable:   { backgroundColor: "#14532d", color: "#4ade80",  fontSize: "0.68rem", fontWeight: "600", padding: "0.2rem 0.6rem", borderRadius: "6px", textTransform: "uppercase", letterSpacing: "0.04em" },
  badgeMaintenance: { backgroundColor: "#431407", color: "#fb923c",  fontSize: "0.68rem", fontWeight: "600", padding: "0.2rem 0.6rem", borderRadius: "6px", textTransform: "uppercase", letterSpacing: "0.04em" },
  badgeInUse:       { backgroundColor: "#422006", color: "#fbbf24",  fontSize: "0.68rem", fontWeight: "600", padding: "0.2rem 0.6rem", borderRadius: "6px", textTransform: "uppercase", letterSpacing: "0.04em" },
  badgeRetired:     { backgroundColor: "#1a1a1a", color: "#555555",  fontSize: "0.68rem", fontWeight: "600", padding: "0.2rem 0.6rem", borderRadius: "6px", textTransform: "uppercase", letterSpacing: "0.04em" },
