      ...
      <div style={styles.inner}>
        ...
        <div style={styles.section}>
          <div style={styles.sectionHeader}>
            ...
            <Link to="/plans" style={styles.sectionLink}>Browse plans</Link>
          </div>
        ...
        <div style={styles.section}>
          ...
          {loadingBook ? (
            ...
            <div style={styles.empty}>
              ...
              <Link to="/classes" style={styles.sectionLink}>Browse classes →</Link>
            </div>
          ) : (
            <div style={styles.card}>
              {bookings.map((booking, i) => {
                ...
                return (
                  <div key={booking._id} style={isLast ? styles.rowLast : styles.row}>
                    <div style={styles.rowLeft}>
                      <div style={styles.rowTitle}>{booking.classId?.name}</div>
                      <div style={styles.rowSub}>
                        {booking.classId?.scheduledAt
                          ? formatDateTime(booking.classId.scheduledAt)
                          : "—"}
