      ...
      <div style={styles.inner}>
        ...
        <div style={styles.section}>
          <div style={styles.sectionHeader}>
            ...
            {!subscription && (
              <Link to="/plans" style={styles.sectionLink}>
                Browse plans
              </Link>
            )}
          </div>
        ...
        <div style={styles.section}>
          <div style={styles.sectionHeader}>
            ...
            <Link to="/classes" style={styles.sectionLink}>
              Book more
            </Link>
          </div>
          {loadingBook ? (
                ...
                return (
                  <div key={b._id} style={isLast ? styles.rowLast : styles.row}>
                    <div>
                      ...
                      <div style={styles.rowSub}>
                        {b.classId?.scheduledAt
                          ? formatDateTime(b.classId.scheduledAt)
                          : "—"}
                        {b.classId?.instructor
                          ? ` · ${b.classId.instructor}`
                          : ""}
                      </div>
                    </div>
        ...
        <div style={styles.section}>
          <div style={styles.sectionHeader}>
            ...
            <Link to="/market" style={styles.sectionLink}>
              Browse market
            </Link>
          </div>
          {loadingRes ? (
